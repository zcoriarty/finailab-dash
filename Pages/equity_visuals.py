...
def create_drop_down_options(json_file, dictionary=True):
	with open("Static/Dropdown Data/" + json_file, "r") as read_file:
...
with open("Static/Dropdown Data/sector_per_company.json", "r") as read_file:
	sector_per_company = json.load(read_file)

with open("Static/Dropdown Data/industry_per_company.json", "r") as read_file:
